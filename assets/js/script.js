...
function runGame(gameType) {
    ...
    if (gameType === "addition") {
        ...
        throw `unknown game typee: ${gameType}. aborting!`;
    }
}
...
/**
 * gets the operands (the numbers) and the ioperator (plus, minus etc)
...
function calculateCorrectAnswer() {
    ...
    if (operator === "+") {
        ...
        throw `unimpmemented operator ${operator}. aborting`;
    }
